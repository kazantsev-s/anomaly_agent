...
Результаты custom SQL с result_kind = anomaly_candidates описывай как кандидатов в аномалии.
Результаты custom SQL с result_kind = context используй только для объяснения и не называй отдельными аномалиями.
